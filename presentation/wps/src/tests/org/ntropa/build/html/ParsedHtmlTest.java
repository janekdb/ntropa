...
/**
 * FIXME: Rename to ParsedHtml.java (and class)
 * 
 * @author jdb
...
public class ParsedHtmlTest extends TestCase {
	...
	final List SimpleHtmlPageTagList = Arrays.asList(new String[] { "!DOCTYPE", "html", "head", "title", "/title",
			"/head", "body", "img", "ul", "li", "li", "li", "/ul", "div", "/div", "/body", "/html" });
	...
	final List ScriptHtmlPageTagList = Arrays.asList(new String[] { "!DOCTYPE", "html", "head", "title", "/title",
			"script", "/script", "script", "/script", "/head", "body", "ul", "li", "li", "li", "/ul", "div", "/div",
			"/body", "/html" });
	...
	final List ServerActiveHtmlHtmlPageTagList = Arrays.asList(new String[] { "!DOCTYPE", "html", "head", "title",
			"/title", "/head", "body", "!--", "!--", "ul", "!--", "!--", "li", "!--", "!--", "/ul", "!--", "!--",
			"div", "/div", "/body", "/html" });
	 ...
	 * 
	 * This test established that DTD was not being produced here on bonecracker,
	 * NAVDEV and NAVTEST, but it was being produced on XENOLITH. Presumably this
	 * is because of an older version of XERCES on XENOLITH.
	 */
